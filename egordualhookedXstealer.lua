...
function Library:Window(title)
    ...
    Main.Name = "Main"
    Main.Parent = ui
    Main.BackgroundColor3 = Color3.fromRGB(0, 204, 255)
    ...
    tabs.Name = "tabs"
    tabs.Parent = Main
    tabs.BackgroundColor3 = Color3.fromRGB(204, 255, 255)
    ...
    Cover_2.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=17060611888"
    ...
    Close.Image = "http://www.roblox.com/asset/?id=17073637955"
    ...
    Resize.ImageColor3 = Color3.fromRGB(255, 255, 255)
    ...
    Pages.Name = "Pages"
    Pages.Parent = Main
    Pages.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
coroutine.wrap(GRIR_fake_script)()
    ...
    function Tabs:Tab(title)
        ...
        TabButton.BackgroundColor3 = Color3.fromRGB(0, 204, 255)
        TabButton.BackgroundTransparency = 1
        TabButton.Size = UDim2.new(1, -12, 0, 30)
        TabButton.AutoButtonColor = false
        TabButton.Font = Enum.Font.Gotham
        TabButton.Text = title or 'Home'
        TabButton.TextColor3 = Color3.fromRGB(0,204,255)
        ...
        function TabFunctions:Label(labeltext)
            ...
            TextLabel.BackgroundColor3 = Color3.fromRGB(0, 204, 255)
        ...
        function TabFunctions:Dropdown(title, list, callback)
                ...
                Choose.BackgroundColor3 = Color3.fromRGB(0, 204, 255)
                ...
                arrow.ImageColor3 = Color3.fromRGB(0, 204, 255)
